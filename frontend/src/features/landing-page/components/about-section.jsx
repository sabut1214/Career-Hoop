        ...
        <div className="order-1 space-y-6 lg:order-2">
          <Badge variant="default">
            ...
            <div className="grid gap-4 pt-4 sm:grid-cols-3">
              <div className="flex flex-col items-center gap-2 rounded-xl bg-card p-4 text-center shadow-sm border border-border/50 transition-all duration-300 hover:shadow-md focus-within:ring-2 focus-within:ring-ring focus-within:ring-offset-2">
